...
from nautobot_ssot_device42.diffsync.models.base.assets import PatchPanel, PatchPanelFrontPort, PatchPanelRearPort
...
from nautobot_ssot_device42.diffsync.models.nautobot.assets import (
    NautobotPatchPanel,
    NautobotPatchPanelFrontPort,
    NautobotPatchPanelRearPort,
)
from nautobot_ssot_device42.diffsync.models.nautobot.circuits import NautobotCircuit, NautobotProvider
from nautobot_ssot_device42.diffsync.models.nautobot.dcim import (
    NautobotBuilding,
    NautobotCluster,
    NautobotConnection,
    NautobotDevice,
