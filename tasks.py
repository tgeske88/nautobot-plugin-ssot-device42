...
namespace.configure(
    {
        "nautobot_ssot_device42": {
            "nautobot_ver": "latest",
            "project_name": "nautobot_ssot_device42",
            "python_ver": "3.8",
            "local": False,
...
def docker_compose(context, command, **kwargs):
    ...
    build_env = {
        ...
        "COMPOSE_HTTP_TIMEOUT": context.nautobot_ssot_device42.compose_http_timeout,
        "NAUTOBOT_VER": context.nautobot_ssot_device42.nautobot_ver,
        "PYTHON_VER": context.nautobot_ssot_device42.python_ver,
    }
    compose_command_tokens = [
        "docker compose",
        f"--project-name {context.nautobot_ssot_device42.project_name}",
        f'--project-directory "{context.nautobot_ssot_device42.compose_dir}"',
    ]
